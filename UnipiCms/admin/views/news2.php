<!-- to work properly change queries case news to news2 -->
  ...
  <div class="row">
    ...
    <div class="col-md-6">
        <div class="list-group">
          ...
          <a class="list-group-item" href="?page=news2"><i class="fa fa-plus"></i> New Post</a>
          ...
          ?>
              <div id="news2_<?php echo $list['id']; ?>" style=" overflow: auto;" class="list-group-item <?php selected($list['id'],$opened['id'],'active') ?>">

                  <h4 data-toggle="collapse" data-target="#form_<?php echo $list['id']; ?>" class="list-group-item-heading"><i style="float:left;" class="fa fa-chevron-down"></i> &nbsp <?php echo $list['title']; ?>
                    <span class= "pull-right">
                      <a href="#" id = "del_<?php echo $list['id']; ?>" class="btn btn-danger btn-delete-post"><i class="fa fa-trash-o"></i></a>
                      <a href="index.php?page=news2&id=<?php echo $list['id']; ?>" class="btn btn-default"><i class="fa fa-pencil-square-o"></i></a>
                    </span>
                  </h4>
                  ...
                  <div id="form_<?php echo $list['id']; ?>" class="collapse" style="overflow:auto; max-height:500px;">
    ...
    <div class="col-md-6">
      ...
      <form action="index.php?page=news2&id=<?php echo $opened['id']; ?>" method="post" role = "form" onSubmit="return validate_form_news();">
