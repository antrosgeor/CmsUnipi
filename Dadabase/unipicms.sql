...
(5, 'ant georu', 'ants@hotmail.gr', '6985042561', 'This method of authentication is a type of multi-factor authentication and is providing an additional layer of security due to the fact that an attacker is unlikely to be able to supply both factors required for access. Many websites support two-factor authentication nowadays, including PayPal, Facebook, eBay, Yahoo and many others.', '2015-10-01', 'read'),
(6, 'fasou thsis', 'thans@gmail.com', '6984596540', 'Each user who wants to enable two-factor authentication will have to download the Google authenticator mobile app. After that, the mobile app needs to be connected to your website, which can be done either via the secret code or the QR code. In other words, the website will have to generate a different secret code for each user and store it in the database. First, we will use Composer to install the PHP package, which will be used for secret code generation', '2015-10-01', 'read'),
(10, 'georgs naoum ', 'geors@naoum.gr', '6909090909', '. Many websites support two-factor authentication nowadays, including PayPal, Facebook, eBay, Yahoo and many others.', '2015-11-03', 'unread'),
(11, 'stamai pavloy ', 'stams@pavlou.gr', '6998793392', 'After that, the mobile app needs to be connected to your website, which can be done either via the secret code or the QR code. In other words, the website will have to generate a different secret code for each user and store it in the database. First, we will use Composer to install the PHP package, which will be used for secret code generation', '2015-11-03', 'unread');
...
(1, '', 'Thas ', 'Fasos', 'than@hotmail.gr', '7c4a8d09ca3762afe59543dc26494f8941b', 1),
(11, '', 'Ants', 'Georg', 'ant@hotmail.gr', '7c3c5fb8d955307f18957f9deaad5869abcd', 1);
